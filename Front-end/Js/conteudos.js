...
// ==================== ALTERAÇÃO 1: ABRIR E RESETAR (CORREÇÃO DE CLIQUE) ====================
if (btnAbaOp) {
    btnAbaOp.addEventListener('click', (e) => {
        // [ALTERAÇÃO]: stopPropagation impede que o clique no botão 
        // seja interpretado como um clique no "fundo" (que fecharia o modal).
        e.stopPropagation(); 
        
        // [ALTERAÇÃO]: Força o reset das etapas para sempre começar na 1
